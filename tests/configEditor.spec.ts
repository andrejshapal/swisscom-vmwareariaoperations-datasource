...
import { AriaSourceOptions, AriaSecureJsonData } from '../src/types';
...
test('"Save & test" should be successful when configuration is valid', async ({
  ...
  const ds = await readProvisionedDataSource<AriaSourceOptions, AriaSecureJsonData>({ fileName: 'datasources.yml' });
