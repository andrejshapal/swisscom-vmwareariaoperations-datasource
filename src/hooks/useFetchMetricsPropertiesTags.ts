...
export default (
  ...
  const [cache, setCache] = useState<Map<string, [string[], string[], string[]]>>(
  ...
  }, [datasource, builderOptions.functions.resourceKind, builderOptions.functions.adapterKind, builderOptions, cache]);
