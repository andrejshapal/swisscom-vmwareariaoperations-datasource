...
const createAction = (type: BuilderOptionsActionType, payload: Partial<Functions | Filters | Collectors | QueryBuilderOptions | CustomFilter[]>): BuilderOptionsReducerAction => ({
    type,
    payload
});
...
const actions = new Map<BuilderOptionsActionType, Reducer<QueryBuilderOptions, BuilderOptionsReducerAction>>([
    ...
    [BuilderOptionsActionType.SetAdapterKind, (state: QueryBuilderOptions, action: BuilderOptionsReducerAction): QueryBuilderOptions => {
    ...
    [BuilderOptionsActionType.SetResourceKind, (state: QueryBuilderOptions, action: BuilderOptionsReducerAction): QueryBuilderOptions => {
        const functions: Functions = {
            ...state.functions,
    ...
    [BuilderOptionsActionType.SetWhereHealth, (state: QueryBuilderOptions, action: BuilderOptionsReducerAction): QueryBuilderOptions => {
    ...
    [BuilderOptionsActionType.SetWhereState, (state: QueryBuilderOptions, action: BuilderOptionsReducerAction): QueryBuilderOptions => {
        const filters: Filters = {
            ...state.filters,
    ...
    [BuilderOptionsActionType.SetWhereStatus, (state: QueryBuilderOptions, action: BuilderOptionsReducerAction): QueryBuilderOptions => {
        const filters: Filters = {
            ...state.filters,
    ...
    [BuilderOptionsActionType.SetWhereTag, (state: QueryBuilderOptions, action: BuilderOptionsReducerAction): QueryBuilderOptions => {
        const filters: Filters = {
            ...state.filters,
    ...
    [BuilderOptionsActionType.SetWithProperty, (state: QueryBuilderOptions, action: BuilderOptionsReducerAction): QueryBuilderOptions => {
    ...
    [BuilderOptionsActionType.SetWithMetric, (state: QueryBuilderOptions, action: BuilderOptionsReducerAction): QueryBuilderOptions => {
        const functions: Functions = {
            ...state.functions,
    ...
    [BuilderOptionsActionType.SetWithFilter, (state: QueryBuilderOptions, action: BuilderOptionsReducerAction): QueryBuilderOptions => {
        return buildInitialState({
            collectors: state.collectors,
            functions: state.functions,
            filters: state.filters,
