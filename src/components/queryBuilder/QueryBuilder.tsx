...
import {
    BuilderOptionsReducerAction, setAdapterKind,
    setQueryType,
    setResourceKind, setWhereHealth, setWhereState, setWhereStatus,
    setWithFilters, setWithMetric, setWithProperty
...
export const QueryBuilder = (props: QueryBuilderProps) => {
    ...
    const FiltersMap: KeyValue<[string[], MultiChangeFunction, Labels, UseFetch]> = {
        "whereHealth": [builderOptions.filters.whereHealth, onWhereHealthChange, labels.components.filters.WhereHealthSelect, useFetchHealth],
        "whereState": [builderOptions.filters.whereState, onWhereStateChange, labels.components.filters.WhereStateSelect, useFetchState],
        "whereStatus": [builderOptions.filters.whereStatus, onWhereStatusChange, labels.components.filters.WhereStatusSelect, useFetchStatus],
    };
    return (
